...
writeAPIkey = "YXMRSP0G6NDXUCW8" # Replace YOUR-CHANNEL-WRITEAPIKEY with your channel write API key
channelID = "431529" # Replace YOUR-CHANNELID with your channel ID
...
def getData():
	...
	cpuTemp = 30 #process.split('=')[1].split("'")[0]
	cpuUsage = 80 #psutil.cpu_percent(interval=2)
